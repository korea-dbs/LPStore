...
extern u32 ovflPageCnt;
extern int tempBtreeFlag;
int sqlite3WalOpen(
		    wal_manager_impl *self,
		    sqlite3_vfs *pVfs,
	            sqlite3_file *pDbFd,
	            int pOvflFd,             /* Dohwan added */
		    int bNoShm,
		    i64 mxWalSize,
		    const char *main_db_file_name,
		    libsql_wal *out);

int sqlite3WalFindFrame(Wal *pWal, u32 pgno, u32 *piFrame);
int sqlite3WalReadFrame(Wal *pWal, u32 iFrame, int nOut, u8 *aOut);
//end
#endif /* SQLITEINT_H */
