...
name="dbs/sqlite3_96col_ovfl_"+sys.argv[1]+"_text.db"
...
for i in range(1, 50000):
    cursor.execute("INSERT INTO test(_id, samp, description, mini_thumb_magic, data) VALUES (?, ?, ?, ?, ?);", (i, samptext, samptext, 89+(i % 100), payload))
